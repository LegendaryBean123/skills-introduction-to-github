...
![screenshot of green merge pull request button](https://github.com/LegendaryBean123/skills-introduction-to-github/blob/main/.github/images/merge-pull-request-button.png?raw=true)
...
3. Once your branch has been merged, you don't need it anymore. To delete this branch, click **Delete branch**.
   ...
   ![screenshot showing delete branch button](https://github.com/LegendaryBean123/skills-introduction-to-github/blob/main/.github/images/delete-branch-button.png?raw=true)
