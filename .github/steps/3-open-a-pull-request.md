...
![screenshot of message and button](https://github.com/LegendaryBean123/skills-introduction-to-github/blob/main/.github/images/compare-pull-request-button.png?raw=true)
...
3. Select the following branches using the dropdown menus.
   ...
   ![screenshot showing both branch selections](https://github.com/LegendaryBean123/skills-introduction-to-github/blob/main/.github/images/branch-selection-comparison.png?raw=true)
...
6. The next field helps you provide a **description** of the changes you made. Please enter a short description of what you’ve accomplished so far. As a reminder, you have: created a new branch, created a file, and made a commit.
   ...
   ![screenshot showing pull request](https://github.com/LegendaryBean123/skills-introduction-to-github/blob/main/.github/images/create-pull-request-form.png?raw=true)
