...
2. Select the **Add file** drop-down and click **Create new file**.
   ...
   <img width="300" alt="screenshot of the create new file option" src="https://github.com/LegendaryBean123/skills-introduction-to-github/blob/main/.github/images/create-new-file-option.png?raw=true">
...
4. In the **Enter file contents here** area, copy the following content to your file:
   ...
   ![screenshot for adding the profile.md file](https://github.com/LegendaryBean123/skills-introduction-to-github/blob/main/.github/images/add-profile-file.png?raw=true)
...
6. GitHub will suggest a commit message, but let's set one ourselves for practice. Enter `Add PROFILE.md` in the **Commit message** field.
   ...
   <img width="400" alt="screenshot of adding a new file with a commit message" src="https://github.com/LegendaryBean123/skills-introduction-to-github/blob/main/.github/images/commit-message-dialog.png?raw=true">
